package corr.ai.module.infra.service.codegen.inner;
...
import corr.ai.framework.apilog.core.enums.OperateTypeEnum;
...
import corr.ai.framework.common.util.object.ObjectUtils;
import corr.ai.framework.common.util.string.StrUtils;
import corr.ai.framework.excel.core.annotations.DictFormat;
import corr.ai.framework.excel.core.convert.DictConvert;
...
import corr.ai.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "corr-module-${table.moduleName}/" + // 顶级模块
                "corr-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "corr-module-${table.moduleName}/" + // 顶级模块
                "corr-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "corr-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "corr-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
