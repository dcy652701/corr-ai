package corr.ai.module.infra.service.db;

import corr.ai.framework.common.util.object.BeanUtils;
import corr.ai.framework.mybatis.core.util.JdbcUtils;
import corr.ai.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import corr.ai.module.infra.dal.dataobject.db.DataSourceConfigDO;
import corr.ai.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static corr.ai.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
import static corr.ai.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_OK;
