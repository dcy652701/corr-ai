package corr.ai.module.infra.service.config;

import corr.ai.framework.common.pojo.PageResult;
import corr.ai.module.infra.controller.admin.config.vo.ConfigPageReqVO;
import corr.ai.module.infra.controller.admin.config.vo.ConfigSaveReqVO;
import corr.ai.module.infra.convert.config.ConfigConvert;
import corr.ai.module.infra.dal.dataobject.config.ConfigDO;
import corr.ai.module.infra.dal.mysql.config.ConfigMapper;
import corr.ai.module.infra.enums.config.ConfigTypeEnum;
