package corr.ai.module.infra.service.codegen;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import corr.ai.framework.common.pojo.PageResult;
import corr.ai.framework.common.util.object.BeanUtils;
import corr.ai.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import corr.ai.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import corr.ai.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import corr.ai.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import corr.ai.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import corr.ai.module.infra.dal.dataobject.codegen.CodegenTableDO;
import corr.ai.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import corr.ai.module.infra.dal.mysql.codegen.CodegenTableMapper;
import corr.ai.module.infra.enums.codegen.CodegenSceneEnum;
import corr.ai.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import corr.ai.module.infra.framework.codegen.config.CodegenProperties;
import corr.ai.module.infra.service.codegen.inner.CodegenBuilder;
import corr.ai.module.infra.service.codegen.inner.CodegenEngine;
import corr.ai.module.infra.service.db.DatabaseTableService;
import corr.ai.module.system.api.user.AdminUserApi;
...
import static corr.ai.framework.common.util.collection.CollectionUtils.convertMap;
import static corr.ai.framework.common.util.collection.CollectionUtils.convertSet;
import static corr.ai.module.infra.enums.ErrorCodeConstants.*;
