package corr.ai.module.system.service.social;
...
import corr.ai.framework.common.util.cache.CacheUtils;
import corr.ai.framework.common.util.http.HttpUtils;
import corr.ai.framework.common.util.object.BeanUtils;
import corr.ai.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import corr.ai.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import corr.ai.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import corr.ai.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import corr.ai.module.system.dal.dataobject.social.SocialClientDO;
import corr.ai.module.system.dal.mysql.social.SocialClientMapper;
...
import static corr.ai.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${corr.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${corr.wxa-subscribe-message.miniprogram-state:formal}")
