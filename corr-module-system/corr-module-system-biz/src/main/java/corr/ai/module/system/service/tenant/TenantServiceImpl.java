...
import corr.ai.framework.tenant.config.TenantProperties;
import corr.ai.framework.tenant.core.context.TenantContextHolder;
import corr.ai.framework.tenant.core.util.TenantUtils;
import corr.ai.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import corr.ai.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import corr.ai.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import corr.ai.module.system.convert.tenant.TenantConvert;
import corr.ai.module.system.dal.dataobject.permission.MenuDO;
import corr.ai.module.system.dal.dataobject.permission.RoleDO;
...
import corr.ai.module.system.dal.mysql.tenant.TenantMapper;
import corr.ai.module.system.enums.permission.RoleCodeEnum;
import corr.ai.module.system.enums.permission.RoleTypeEnum;
import corr.ai.module.system.service.permission.MenuService;
...
import corr.ai.module.system.service.tenant.handler.TenantInfoHandler;
import corr.ai.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 corr.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
