...
public class OAuth2TokenApiImpl implements OAuth2TokenApi {
    ...
    @Override
    public CommonResult<String> getAccessTokenByLoginUser(Long userId) {
        String accessTokenByLoginUser = oauth2TokenService.getAccessTokenByLoginUser(userId);
        return success(accessTokenByLoginUser);
    }
