...
public interface MemberUserService {
     ...
     * @param userId
     */
    void updateWalletAddress(Long userId, String address);
     ...
     * @param vipId
     */
    void applyVipInfo(Long userId, Long vipId);
     ...
     * @return
     */
    MemberUserDO getUserByWallet(String walletAddress);
     ...
     * @return
     */
    MemberUserDO createUserByEmailIfAbsent(@Email String email, String password, String registerIp, Integer terminal);
     ...
     * @return
     */
    MemberUserDO createUserByWalletIfAbsent(String walletAddress, String password, String registerIp, Integer terminal);
