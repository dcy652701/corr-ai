package corr.ai.module.member.convert.user;

import corr.ai.framework.common.pojo.PageResult;
import corr.ai.module.member.api.user.dto.MemberUserRespDTO;
import corr.ai.module.member.controller.admin.user.vo.MemberUserRespVO;
import corr.ai.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import corr.ai.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
