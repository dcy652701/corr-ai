package corr.ai.module.infra.controller.admin.logger.vo.apierrorlog;

import corr.ai.framework.excel.core.annotations.DictFormat;
import corr.ai.framework.excel.core.convert.DictConvert;
import corr.ai.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(corr.ai.module.system.enums.DictTypeConstants.USER_TYPE)
