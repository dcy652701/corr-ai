package corr.ai.module.member.dal.mysql.user;
...
public interface MemberUserMapper extends BaseMapperX<MemberUserDO> {
    ...
    default MemberUserDO selectUserByEmail(String email) {
        LambdaQueryWrapperX<MemberUserDO> wrapperX = new LambdaQueryWrapperX<>();
        wrapperX.eq(MemberUserDO::getEmail, email);
        return selectOne(wrapperX);
    }

    default MemberUserDO selectUserByWallet(String walletAddress) {
        LambdaQueryWrapperX<MemberUserDO> wrapperX = new LambdaQueryWrapperX<>();
        wrapperX.eq(MemberUserDO::getWalletAddress, walletAddress);
        return selectOne(wrapperX);
    }
