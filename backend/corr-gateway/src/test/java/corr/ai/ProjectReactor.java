...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "corr.ai";
    private static final String ARTIFACT_ID = "corr";
    private static final String PACKAGE_NAME = "corr.ai";
    private static final String TITLE = "Corr.Ai量化交易系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "corr.ai";
        String artifactIdNew = "corr";
        String packageNameNew = "corr.ai";
        String titleNew = "Corr.Ai量化交易系统";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "/Users/dongchengye/Documents/work_space/corr-ai-backend"; // 一键改名后，“新”项目所在的目录
