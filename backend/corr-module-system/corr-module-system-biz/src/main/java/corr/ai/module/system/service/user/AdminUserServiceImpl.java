package corr.ai.module.system.service.user;
...
import corr.ai.framework.common.util.collection.CollectionUtils;
import corr.ai.framework.common.util.object.BeanUtils;
import corr.ai.framework.common.util.validation.ValidationUtils;
import corr.ai.framework.datapermission.core.util.DataPermissionUtils;
import corr.ai.module.infra.api.config.ConfigApi;
import corr.ai.module.infra.api.file.FileApi;
import corr.ai.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import corr.ai.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import corr.ai.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import corr.ai.module.system.controller.admin.user.vo.user.UserImportRespVO;
import corr.ai.module.system.controller.admin.user.vo.user.UserPageReqVO;
import corr.ai.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import corr.ai.module.system.dal.dataobject.dept.DeptDO;
import corr.ai.module.system.dal.dataobject.dept.UserPostDO;
import corr.ai.module.system.dal.dataobject.user.AdminUserDO;
import corr.ai.module.system.dal.mysql.dept.UserPostMapper;
import corr.ai.module.system.dal.mysql.user.AdminUserMapper;
import corr.ai.module.system.service.dept.DeptService;
...
import static corr.ai.framework.common.util.collection.CollectionUtils.convertList;
...
import static corr.ai.module.system.enums.LogRecordConstants.*;
