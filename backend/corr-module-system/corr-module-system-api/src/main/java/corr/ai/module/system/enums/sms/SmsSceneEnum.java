package corr.ai.module.system.enums.sms;

import cn.hutool.core.util.ArrayUtil;
import corr.ai.framework.common.core.IntArrayValuable;
...
public enum SmsSceneEnum implements IntArrayValuable {
    ...
    MEMBER_EMAIL_REGISTER(5, "user-email-sms-login", "会员用户-邮箱注册"),
    MEMBER_EMAIL_RESET_PASSWORD(6, "user-email-sms-reset-password", "会员用户-重置密码"),
