...
import corr.ai.framework.common.enums.DocumentEnum;
import corr.ai.framework.mq.redis.core.RedisMQTemplate;
import corr.ai.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import corr.ai.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import corr.ai.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class CorrRedisMQConsumerAutoConfiguration {
