package corr.ai.framework.security.core.util;
...
public class SecurityFrameworkUtils {
    ...
    @Nullable
    public static Long getLoginUserVipId() {
        LoginUser loginUser = getLoginUser();
        return loginUser != null ? MapUtil.getLong(loginUser.getInfo(), LoginUser.VIP_ID) : null;
    }

    public static String getUserWalletAddress(){
        LoginUser loginUser = getLoginUser();
        return loginUser != null ? MapUtil.getStr(loginUser.getInfo(), LoginUser.WALLET_ADDRESS) : null;
    }
