package corr.ai.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${corr.websocket.sender-rocketmq.topic}",
        consumerGroup = "${corr.websocket.sender-rocketmq.consumer-group}",
