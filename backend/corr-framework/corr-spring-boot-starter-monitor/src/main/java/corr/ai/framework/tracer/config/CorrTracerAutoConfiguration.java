package corr.ai.framework.tracer.config;

import corr.ai.framework.common.enums.WebFilterOrderEnum;
import corr.ai.framework.tracer.core.aop.BizTraceAspect;
import corr.ai.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "corr.tracer", value = "enable", matchIfMissing = true)
public class CorrTracerAutoConfiguration {
