package corr.ai.framework.ratelimiter.core.annotation;
...
import corr.ai.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import corr.ai.framework.ratelimiter.core.keyresolver.impl.ClientIpRateLimiterKeyResolver;
import corr.ai.framework.ratelimiter.core.keyresolver.impl.DefaultRateLimiterKeyResolver;
import corr.ai.framework.ratelimiter.core.keyresolver.impl.ServerNodeRateLimiterKeyResolver;
import corr.ai.framework.ratelimiter.core.keyresolver.impl.UserRateLimiterKeyResolver;
