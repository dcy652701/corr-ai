package corr.ai.framework.ratelimiter.config;

import corr.ai.framework.ratelimiter.core.aop.RateLimiterAspect;
import corr.ai.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import corr.ai.framework.ratelimiter.core.keyresolver.impl.*;
import corr.ai.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class CorrRateLimiterConfiguration {
