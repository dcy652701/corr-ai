package corr.ai.framework.ip.core.utils;
...
import corr.ai.framework.ip.core.enums.AreaTypeEnum;
...
import static corr.ai.framework.common.util.collection.CollectionUtils.findFirst;
