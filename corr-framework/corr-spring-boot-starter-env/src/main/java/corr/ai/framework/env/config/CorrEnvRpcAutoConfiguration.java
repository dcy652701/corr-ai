...
import corr.ai.framework.env.core.fegin.EnvLoadBalancerClientFactory;
import corr.ai.framework.env.core.fegin.EnvRequestInterceptor;
...
public class CorrEnvRpcAutoConfiguration {
